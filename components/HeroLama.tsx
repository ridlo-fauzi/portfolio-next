...
const HeroSection = () => {
  ...
  return (
    <div
      id="hero"
      className="min-h-screen mt-10 py-16 bg-gray-100 dark:bg-gray-800 flex flex-col items-center justify-between px-6 md:mt-0 md:flex-row md:px-16"
    >
      {/* Kiri */}
      <div className="w-full mb-10 md:w-2/3  md:mb-0">
        ...
        <p className="text-gray-700 dark:text-white text-lg">
          {lang === "id"
            ? "Mahasiswa yang sedang mendalami web development dan UI/UX, fokus pada antarmuka responsif dan pengalaman pengguna yang baik."
            : "A student exploring web development and UI/UX, with a focus on responsive interfaces and great user experiences."}
        </p>
        <div className="flex items-center gap-4 mt-4">
          <div className=" bg-blue-600 hover:bg-blue-700 rounded-2xl text-white px-4 py-2 ">
            <a className="flex items-center" href="/Ridho_Resume.pdf">
              Download Resume
              <svg
                className="inline-block w-9 h-9 ml-2 mb-1 text-blue-50"
